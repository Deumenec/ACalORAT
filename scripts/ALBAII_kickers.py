...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar  4 12:42:55 2026
...
dRijdEnergy_ana= cORM.dRij_dEnergy(cORM.bpm, cORM.cor, cORM.quad, cORM.dip)
dRijdEnergy_quick = np.array(numerical.quickdORMdEnergy(ring, ind))
