...
split_dict = split_fam(ring, ind["cor"]["v"], spl, ind)
...
thickh = np.sum(cORM.dRij_dqk_thin(cORM.bpm, cORM.cor, cORM.quad),axis=3) #+ cORM.dRij_dqk_thick23_disp(cORM.bpm, cORM.cor, cORM.quad, cORM.dip)
